...
This year I have submitted 3 proposals:

* *How I resurrected django-chartit in order to kill it again* - lightning talk
* *What's new in Cosmic Ray ?* - Python devroom
* *Mutants, tests and zombies* - Testing & Automation devroom

CFP is over but there is still no information about which proposals have been accepted.
Regardless of that I will be in Brussels between February 1st and 5th to explore the local
start-up scene and get to meet with the Python community.
...
practical example I'm hoping to gather more information and present my findings
to the world.
